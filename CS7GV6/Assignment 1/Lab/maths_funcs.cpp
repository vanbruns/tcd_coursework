...
// convenience function for translating, transforming, translating back
mat4 translateFirst(const mat4& m, const vec3& v) {
	return translate(identity_mat4(), v)
		* m
		* translate(identity_mat4(), vec3(-v.v[0], -v.v[1], -v.v[2]));
}
...
// returns a orthogonal function mimicing the opengl projection style. COLUMN ORDER
