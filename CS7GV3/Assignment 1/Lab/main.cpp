...
shaders selectedShader = BlinnPhong;
...
bool objectSelected[] = { true, true, true, true, true, true, true, true, true, true };
...
bool viewportVisible[] = { false, false, false, false };
vec3 cameraPosition;
vec3 cameraFront;
vec3 cameraUp;
...
void initSelectedShader() {
	...
	switch (selectedShader) {
		...
		case BlinnPhong:
			...
			glutSetWindowTitle("Reflectance Models: Blinn-Phong Selected");

			break;
		case FlawedBlinnPhong:
			shader = flawedBlinnPhongShader;

			glutSetWindowTitle("Reflectance Models: Flawed Blinn-Phong Selected");

			break;
		case NonPhotoRealistic:
			shader = nonPhotoRealisticShader;

			glutSetWindowTitle("Reflectance Models: Non-Photo Realistic Selected");

			break;
		case Minnaert:
			shader = minnaertShader;

			glutSetWindowTitle("Reflectance Models: Minnaert Selected");

			break;
		case PointLit:
			shader = pointLitShader;

			glutSetWindowTitle("Reflectance Models: Point Lit Selected");
